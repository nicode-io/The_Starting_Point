    ...
    return (
        <section>
            <form onSubmit={handleSubmit} className="log-form">
                ...
                <FormField label="Oui" type="radio" name="Disponibilite" callback={fieldValue => setDisponibilite(fieldValue)}/>
                <FormField label="Non" type="radio" name="Disponibilite" callback={fieldValue => setDisponibilite(fieldValue)} />
