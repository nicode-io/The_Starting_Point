...
This learning path aims to practise SQL in a PHP environment, and so manage database & data. 
It aims to refresh syntax and use data fetching and transactions
