...
namespace GradeBook.Tests
{
    ...
    public class TypeTests
    {
        ...
        public void GetBookSetNameWithRefParam(ref InMemoryBook book, string name) // You can replace 'ref' by 'out', out will throw an error if book is not initialized
        {
        ...
        public void GetBookSetNameWithValueParam(InMemoryBook book, string name)
        {
            book = new InMemoryBook(name);
        }
